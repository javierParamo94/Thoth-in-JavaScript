...
/**
 * <b>Descripción</b><br>
 * Se encarga de proporcionar toda la funcionalidad que debe tener una Máquina de Turing multipista.
 * <p>
 * <b>Detalles</b><br>
 * Nos proporciona todas las operaciones que se pueden obtener de la máquina de
 * estados de una máquina de turing multipista.<br>
...
public class MultiTrackTuringMachine extends TuringMachine implements Cloneable{
    ...
    /**
     * Crea un estado dentro de esta máquina de turing multipista asignándole sólo el nombre.<br>
    ...
    /**
     * Metodo que devuelve el número de pistas de la máquina de turing multipista.
     * 
    ...
    /**
     * Devuelve si la máquina de turing multipista es determinista o no.<br>
    ...
    /**
     * Muestra una cadena con toda la información de la máquina de turing multipista.<br>
