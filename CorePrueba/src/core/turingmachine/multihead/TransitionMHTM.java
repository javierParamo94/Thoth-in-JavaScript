 ...
 * @version 2.0
 */
public class TransitionMHTM extends TransitionTM implements Cloneable{
     ...
     */
    public TransitionMHTM (Vector<Terminal> in, State prevState, Vector<Terminal> write, State nextState, Vector<Character> move){
     ...
     */
    public TransitionMHTM (Vector<Terminal> in, State prevState, Vector<Terminal> write, State nextState, Vector<Character> move, int id){
        mPrevState=prevState;
    	mNextState=nextState;
    	readings=in;
        writings = write;
    ...
    public boolean equals (Object transition){
        if(compare(readings,((TransitionMHTM)transition).getReadings())
            && mNextState.equals(((TransitionMHTM)transition).getNextState())
            && mPrevState.equals(((TransitionMHTM)transition).getPrevState())
            && writings.equals(((TransitionMHTM)transition).getWritings())
            && movements.equals((((TransitionMHTM)transition).getMovements())))
            return true;
     ...
     */
    public TransitionMHTM clone (){
        
        return new TransitionMHTM((Vector<Terminal>)readings.clone(), mPrevState, (Vector<Terminal>)writings.clone(), mNextState, (Vector<Character>)movements.clone());
    }//clone
    ...
    public void setTransitionData(Vector<String> data){
    	...
    	TransitionMHTM temp=(TransitionMHTM)ite.next();
    	while(ite.hasNext()){
