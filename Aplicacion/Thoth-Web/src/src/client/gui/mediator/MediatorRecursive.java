...
public class MediatorRecursive {
     ...
     * otra pestaña.
     * 
     * @param frame Frame al que estará asociado el algoritmo de recursión.
     * @param grammar Gramática a la que se quiere eliminar la recursión.
     */
    public MediatorRecursive(Grammar grammar) {
        ...
        if(flag){
            /*Application app = (Application)frame;
            
            app.createTab(Messages.GRAMMAR + " " + Actions.mCountGram,
                    new PanelGrammar(grammar));
            Actions.mCountGram++;
